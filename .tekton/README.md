...
To modify the pipelines for `trustyai-service` in the `rhoai-3.6-ea.2` release:
...
```bash
cd pipelineruns/trustyai-service/.tekton
```
...
```bash
git commit -am "Update pipelinerun for trustyai-service (rhoai-3.6-ea.2)"
